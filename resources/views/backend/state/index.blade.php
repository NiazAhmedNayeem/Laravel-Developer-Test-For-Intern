            ...
            <form id="addStateForm" action="javascript:void(0)">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" id="state_name" placeholder="Enter State name" required>
                    </div>
                </div>
            ...
            <form id="editStateForm" action="javascript:void(0)">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" id="edit_state_name" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
